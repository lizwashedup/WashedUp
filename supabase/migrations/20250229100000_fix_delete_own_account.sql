-- Fix delete_own_account: wrap optional tables in IF EXISTS, add auth.users delete
-- message_likes and chat_reads may not exist in all deployments
...
BEGIN
  ...
  -- 4. Explore wishlists (if table exists)
