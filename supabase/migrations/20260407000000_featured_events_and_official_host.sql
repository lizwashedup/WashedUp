-- Add is_official_host to profiles
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS is_official_host boolean DEFAULT false;

-- Set liz@washedup.app as official host
UPDATE profiles
SET is_official_host = true
WHERE email = 'liz@washedup.app';

-- Drop and recreate get_filtered_feed to return is_featured
